...
const FORM_SOURCES = {
  "form-kit": formKit,
  "quick-add": quickAdd,
  plans: read("pages/plans.tsx"),
  accounts: read("pages/accounts.tsx"),
  debts: read("pages/debts.tsx"),
  goals: read("pages/goals.tsx"),
  budgets: read("pages/budgets.tsx"),
};

const PAGE_SOURCES = {
  dashboard: read("pages/dashboard.tsx"),
  history: read("pages/transactions.tsx"),
  plans: read("pages/plans.tsx"),
  analytics: read("pages/analytics.tsx"),
  accounts: read("pages/accounts.tsx"),
  debts: read("pages/debts.tsx"),
  goals: read("pages/goals.tsx"),
  budgets: read("pages/budgets.tsx"),
  menu: read("pages/more.tsx"),
  bot: read("pages/bot.tsx"),
