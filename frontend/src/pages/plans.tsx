...
import {
  ...
  shortDate,
  todayISO,
} from "@hisobchi/shared/lib/money";
import { amountError, formatAmountInput, isDirtyDraft, parseAmountInput } from "@/lib/form-kit";
import { filterPlansByTab, monthCashflow, monthPlanned, nextCreditInstallment } from "@hisobchi/shared/lib/finance";
import type { ExpectedIncomeView, Forecast, PlanLifecycle, PlanListTab, RecurringView } from "@hisobchi/shared/lib/finance";
      ...
      <Card className="module-card">
        ...
        {risks.length ? (
          <>
            ...
            <Link to="/" className="mt-2 inline-block text-[12px] font-semibold text-accent-text">
              To‘liq izoh → Asosiy
            </Link>
          </>
        ) : (
