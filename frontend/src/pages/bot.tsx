...
import { API_BASE, BOT_USERNAME, IS_DEV } from "@/lib/api";
import { useFinance } from "@/components/providers";
import { Button, Card, Skeleton, TextInput } from "@/components/ui";
import { ERRORS } from "@hisobchi/shared/lib/copy";
import { BUTTON, startNew } from "@hisobchi/shared/lib/bot-copy";
import { formatAmount } from "@hisobchi/shared/lib/money";
...
const BOT_CONSOLE_ENABLED = IS_DEV;
...
Botga Telegram chatidan /start, /report, /forecast yoki /help yuboring. Operatsiyalar Mini App bilan bir xil bazaga yoziladi.
  ...
  async function send(text: string, confirm?: Record<string, unknown> | null) {
    ...
    setBusy(true);
    try {
      const res = await fetch(`${API_BASE}/api/bot`, {
        method: "POST",
